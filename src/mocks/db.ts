...
export const mockProducts: Product[] = [
  ...
  { id: 'p5', name: 'Body Splash Vainilla', price: 12900, category: 'perfumes', description: 'Dulce y liviano para uso diario.', imageUrl: 'https://images.unsplash.com/photo-1541643600914-78b084683601', active: true, stock: 12, attributes: { marca: 'Coco', fragancia: 'Vainilla', contenido: '200ml' } },
